...
export default function Event() {
  ...
  return (
    ...
    >
      ...
      <SafeAreaView className='absolute  flex flex-row justify-between items-center w-full'>
      ...
      <View className=' p-3 flex gap-5 '>
        <View className=' rounded-[10px] p-3 gap-2 '>
          ...
          <Text className=' text-lg text-slate-500'>
            ...
            container (via a scroll interaction). In order to bound the height
            of a ScrollView, either set the height of the view directly
            (discouraged) or make sure all parent views have bounded height.
          </Text>
        </View>
